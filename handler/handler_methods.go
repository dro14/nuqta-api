...
func (h *Handler) Run(port string) error {
	...
	group.POST("/private", h.createPrivate)
	group.PATCH("/private", h.viewPrivate)
	group.PUT("/private", h.editPrivate)
	group.DELETE("/private", h.deletePrivate)
	group.HEAD("/private", h.removePrivate)
	group.OPTIONS("/private", h.typePrivate)
